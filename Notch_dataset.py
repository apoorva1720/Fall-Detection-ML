...
knn_file = open(("Notch_Results.csv"), "w")
writer = csv.writer(knn_file)

data_time_s = time.time()
dataset1 = pd.read_csv('32ms_User1_LeftWrist.csv')
dataset2 = pd.read_csv('32ms_User2_LeftWrist.csv')
dataset3 = pd.read_csv('32ms_User3_LeftWrist.csv')
dataset4 = pd.read_csv('32ms_User4_LeftWrist.csv')
dataset5 = pd.read_csv('32ms_User5_LeftWrist.csv')
dataset6 = pd.read_csv('32ms_User6_LeftWrist.csv')
dataset7 = pd.read_csv('32ms_User7_LeftWrist.csv')
