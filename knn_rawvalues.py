...
dataset_1 = pd.read_csv('user1.csv',header=None)
dataset_2 = pd.read_csv('user2.csv',header=None)
dataset_3 = pd.read_csv('user3.csv',header=None)
dataset_4 = pd.read_csv('user4.csv',header=None)
dataset_5 = pd.read_csv('user5.csv',header=None)
dataset_6 = pd.read_csv('user6.csv',header=None)
dataset_7 = pd.read_csv('user7.csv',header=None)
dataset_8 = pd.read_csv('user8.csv',header=None)
dataset_9 = pd.read_csv('user9.csv',header=None)
dataset_10 = pd.read_csv('user10.csv',header=None)
dataset_1.drop(dataset_1.columns[[4,5]],axis = 1, inplace = True)

df = [dataset_1, dataset_2, dataset_3, dataset_4, dataset_5, dataset_6, dataset_7, dataset_8, dataset_9, dataset_10]
